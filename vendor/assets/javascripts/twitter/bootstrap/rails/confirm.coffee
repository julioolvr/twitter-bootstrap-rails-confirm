$ ->
  TwitterBootstrapConfirmBox = (message, element, callback) ->
    title_element = element.data("confirm-titleelement") || 'h3'

    $(document.body).append($('
      <div class="modal hide" id="confirmation_dialog">
        <div class="modal-header"><button type="button" class="close" data-dismiss="modal">×</button><' + title_element + '>...</' + title_element + '></div>
    ...
    $("#confirmation_dialog .modal-header #{title_element}").html(message || window.top.location.origin)
